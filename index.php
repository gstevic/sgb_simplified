...
<body>
  ...
  <div class="container">
    ...
    <div class="container">
      ...
      <div class="card-deck mb-3 text-center">
        ...
        <div class="card mb-3 box-shadow">
          ...
          <div class="card-body">
            <ul class="list-unstyled mt-3 mb-1 temp_title">
              <li> <span id="t3_temp_diff"></span></li>
            </ul>
            <h1 class="card-title pricing-card-title temp_color" id="t3_temp"></h1>
            <ul class="list-unstyled mt-3 mb-1 hum_title">
              <li> <span id="t3_hum_diff"></span></li>
            </ul>
            <h1 class="card-title pricing-card-title hum_color" id="t3_hum"></h1>
            <ul class="list-unstyled mt-3 mb-1">
              <li class="sub_text"><span id="t3_time"></span> </li>
        ...
        <div class="card mb-3 box-shadow">
          ...
          <div class="card-body">
            <ul class="list-unstyled mt-3 mb-1 temp_title">
              <li>Trenutno stanje: <span id="t3_temp_diff">OTVORENO <span id="status"></span>cm</span></li>
            </ul>
            <div class="range-slider">
              <input class="input-range" id="m2" type="range" step="1" value="" min="0" max="50">
              <ul class="list-unstyled mt-3 mb-1 temp_title">
                <div id="new-command"> <span class="range-value"></span> </div>
              </ul>
    ...
    ?>
    <script defer src="assets/js/sgb-core-0104.js"></script>
